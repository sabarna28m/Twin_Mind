...
const d: Record<string, React.CSSProperties> = {
  ...
  title:    { margin: 0, fontSize: '1.05rem', fontWeight: 800, color: '#0f172a', letterSpacing: '-0.01em' },
  subtitle: { margin: 0, fontSize: '0.72rem', color: '#64748b', marginTop: '0.15rem' },
  statusBadge: {
  ...
  statLabel: { fontSize: '0.6rem', fontWeight: 700, color: '#64748b', letterSpacing: '0.07em', textTransform: 'uppercase' },
  statValue: { fontSize: '0.92rem', fontWeight: 800, color: '#0f172a' },
  statDivider: { width: '1px', background: '#e2e8f0', flexShrink: 0 },
  swRow: {
  ...
  swLabel: { margin: 0, fontSize: '0.58rem', fontWeight: 700, color: '#64748b', letterSpacing: '0.06em', textTransform: 'uppercase' },
  swValue: { margin: 0, fontSize: '0.82rem', fontWeight: 700, color: '#0f172a', marginTop: '0.1rem' },
  insight: {
    margin: 0,
