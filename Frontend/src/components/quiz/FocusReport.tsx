...
const r: Record<string, React.CSSProperties> = {
  ...
  card:     { background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: '18px', padding: '1.75rem' },
  ...
  integritySection: { textAlign: 'left' as const, padding: '1rem', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '12px' },
  integrityTrack: { height: '8px', background: 'rgba(255,255,255,0.08)', borderRadius: '99px', overflow: 'hidden' },
  ...
  warnItem: { display: 'flex', alignItems: 'center', gap: '0.55rem', padding: '0.5rem 0.75rem', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '8px' },
  ...
  insightCard: { background: 'rgba(0,212,255,0.05)', border: '1px solid rgba(0,212,255,0.15)', borderRadius: '14px', padding: '1.25rem 1.5rem' },
