...
/**
 * Drop-in replacement for <input type="password" className="dark-input">.
 * Renders an eye-icon button inside the field to toggle visibility.
 */
  ...
  return (
    <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
      <input
        ...
        style={{ width: '100%', paddingRight: '2.6rem', ...(rest.style ?? {}) }}
      />
      <button
        type="button"
        tabIndex={-1}
